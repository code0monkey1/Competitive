...
// 	}
// }
// void n_th_position(int position, int data){
...
// 	my_node->next=it->next;
// 	it->next=my_node;

// }
// void delele_nth_position(int position){
// 	node * it=head;
// 	if(position==1){
// 		head=it->next;
// 		free(it);
...
// 	node *node_to_delete=it->next;

// 	it->next=node_to_delete->next;
// 	free(node_to_delete);
// }
// void rec_for_print(node * it){

// 	if(it==NULL)return;

// 	rec_for_print(it->next);
// 	cout<<it->data<<" ";


// }
// void rec_reverse(node * current){

// 	if(current->next==NULL){
// 		head=current;
// 		return;
// 	}
// 	// this looks a bit tricky, but it isnt 
